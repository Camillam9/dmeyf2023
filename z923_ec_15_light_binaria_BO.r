...
PARAM$experimento <- paste0("EC8232_es200_lr15", ".",LR)
...
PARAM$lgb_semilla <- mis_semillas[2]
#------------------------------------------------------------------------------
